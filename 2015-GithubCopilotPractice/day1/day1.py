...
def part1():
    ...
    for char in data:
        # If the character is an opening parenthesis, increment the floor
        if char == '(':
            floor += 1
        # If the character is a closing parenthesis, decrement the floor
        elif char == ')':
            floor -= 1
...
def part2():
    ...
    for char in data:
        ...
        # If the floor is -1, print the position and break the loop
        if floor == -1:
            print(position)
            break
