...
def part1(filename):
    ...
    for i in range(2503):
        for deer in reindeer:
            deer.move()
    print('PART 1: The winning reindeer traveled', max(reindeer, key=lambda x: x.distance).distance, 'km.')
    # PART 1 Answer: 2660
...
def part2(filename):
    ...
    for i in range(2503):
        for deer in reindeer:
            deer.move()
        for deer in reindeer:
            if deer.distance == max(reindeer, key=lambda x: x.distance).distance:
                deer.points += 1
    print('PART 2: The winning reindeer has', max(reindeer, key=lambda x: x.points).points, 'points.')
    # PART 2 Answer: 1256
