...
def main():
    ...
    with open("input.txt") as f:
        ...
        for line in lines:
            ...
            line = line.replace(",", "")
            line = line.split(" ")
            sue["number"] = int(line[1])
            for i in range(2, len(line), 2):
                sue[line[i]] = int(line[i+1])
            sues.append(sue)
        for sue in sues:
            if part1Check(sue, mfcsam):
                print("Part 1: " + str(sue["number"]))
            if part2Check(sue, mfcsam):
                print("Part 2: " + str(sue["number"]))
